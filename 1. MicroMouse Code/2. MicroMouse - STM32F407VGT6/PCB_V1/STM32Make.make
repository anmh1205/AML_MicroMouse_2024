...
GCC_PATH="C:/MAKE/TEST/GCC-ARM-NONE-EABI-9-2019-Q4-MAJOR-WIN32/BIN
ifdef GCC_PATH
...
flash: $(BUILD_DIR)/$(TARGET).elf
	"C:/MAKE/TEST/OPENOCD-20211118-0.11.0/BIN/OPENOCD.EXE" -f ./openocd.cfg -c "program $(BUILD_DIR)/$(TARGET).elf verify reset exit"

#######################################
# erase
#######################################
erase: $(BUILD_DIR)/$(TARGET).elf
	"C:/MAKE/TEST/OPENOCD-20211118-0.11.0/BIN/OPENOCD.EXE" -f ./openocd.cfg -c "init; reset halt; stm32f4x mass_erase 0; exit"
