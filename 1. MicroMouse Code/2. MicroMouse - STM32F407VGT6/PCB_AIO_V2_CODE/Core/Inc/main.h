...
#define IR_SENSOR_BL_Pin GPIO_PIN_0
#define IR_SENSOR_BL_GPIO_Port GPIOC
#define IR_SENSOR_BR_Pin GPIO_PIN_1
#define IR_SENSOR_BR_GPIO_Port GPIOC
...
#define IR_SENSOR_RR_Pin GPIO_PIN_2
#define IR_SENSOR_RR_GPIO_Port GPIOA
#define IR_SENSOR_FR_Pin GPIO_PIN_3
#define IR_SENSOR_FR_GPIO_Port GPIOA
#define IR_SENSOR_FF_Pin GPIO_PIN_6
#define IR_SENSOR_FF_GPIO_Port GPIOA
#define IR_SENSOR_FL_Pin GPIO_PIN_4
#define IR_SENSOR_FL_GPIO_Port GPIOC
#define IR_SENSOR_RL_Pin GPIO_PIN_1
#define IR_SENSOR_RL_GPIO_Port GPIOB
